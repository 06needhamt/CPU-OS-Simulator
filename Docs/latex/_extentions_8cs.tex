...
\begin{DoxyCompactList}\small\item\em This class contains extention methods for getting attributes from enum items \end{DoxyCompactList}\end{DoxyCompactItemize}
